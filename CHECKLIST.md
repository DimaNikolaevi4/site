...
| Задача | Статус | Примечание |
|--------|--------|-------------|
| 6.1 layouts/post.njk — базовый шаблон материала | 🔶 | Работает, но упрощённый. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 6.2 Вложения (PDF, DOCX): блок attachments | ✅ | В post.njk |
| 6.3 Мета: дата + автор под заголовком | ✅ | В post.njk |
| 6.4 «Читайте также» — связанные материалы | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 6.5 Кнопки «Поделиться» (ВКонтакте) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 7.1.3 1.3 Приёмная кампания 2025 | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 7.1.5 1.5 Виртуальная экскурсия | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.1.6 1.6 Подача документов (эл. почта) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.1.7 1.7 Подача документов (почтовая связь) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.1.8 1.8 Платная основа обучения | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.1.9 1.9 Контакты и график работы приёмной комиссии | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |

### 7.2 Раздел 2 — Сведения об образовательной организации (Рособрнадзор №1493)

| Подраздел | Статус | Примечание |
|-----------|--------|-------------|
| 7.2.1 2.1 Основные сведения | ❌ | Файл не создан (basic/). **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.2.2 2.2 Структура и органы управления | 🔶 | svedenija/structure/index.md — есть, 80 строк. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.2.3 2.3 Документы | 🔶 | svedenija/documents/index.md — есть. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.2.4 2.3.1 Документы → Противодействие коррупции | 🔶 | documents/anti-corruption/index.md — есть. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 7.2.7 2.4.2 Международное сотрудничество | 🔶 | svedenija/international/index.md — есть. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 7.2.8 2.5 Руководство | 🔶 | svedenija/employees/index.md — есть, 75 строк. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 8.3 menu.yaml — навигационное меню шапки | 🔶 | Есть. Нужно проверить полноту пунктов. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 9.1.2 JS-переключатель доступности (кнопка на сайте) | 🔶 | Логика localStorage есть, кнопка — нужно проверить/добавить. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 9.1.4 ARIA-метки для интерактивных элементов | 🔶 | В header.njk частично добавлены. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.1.5 Видимый фокус при навигации с клавиатуры | ✅ | Стили в main.css |
| 9.1.6 Минимальный размер области нажатия 44×44px | 🔶 | Стили для мобильных в main.css. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.1.7 Lighthouse Accessibility ≥ 95 | ❌ | Не проверялось. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.1.8 Ссылка «Перейти к основному содержимому» (skip-link) | ❌ | Нужна для навигации с клавиатуры. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 9.2.5 Форма обратной связи с CAPTCHA | ❌ | contacts.md — только текст. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 9.3.3 Open Graph теги (og:title, og:description, og:image) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.3.4 sitemap.xml | 🔶 | sitemap.njk есть, нужно проверить. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.3.5 robots.txt | 🔶 | robots.txt (из njk) есть. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.3.6 Schema.org разметка EducationalOrganization | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.3.7 Каноничные URL (`<link rel="canonical">`) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| Задача | Статус | Примечание |
|--------|--------|-------------|
| 9.4.1 Минификация HTML при сборке | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.4.2 Минификация CSS | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.4.3 Lazy loading изображений (loading="lazy") | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.4.4 WebP формат для изображений | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.4.5 defer / async для JS-скриптов | 🔶 | Частично в base.njk. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 9.4.6 Lighthouse Performance ≥ 90 | ❌ | Не проверялось. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 10.3 Страница /search/ | 🔶 | src/pages/search.njk есть, нужно проверить работу. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 10.4 Строка поиска в шапке | ✅ | В header.njk, с JS |
| 10.5 Поиск по рубрике (фильтр) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 10.6 Поиск по тегам | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| Задача | Статус | Примечание |
|--------|--------|-------------|
| 11.1 src/admin/config.yml — базовая конфигурация | 🔶 | Есть: коллекции news и pages. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 11.2 Backend: git-gateway (требует Netlify Identity) | 🔒 | Нужен выбор хостинга |
| 11.3 Коллекция «Новости» в CMS | 🔶 | Настроена базово. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 11.4 Коллекция «Страницы» в CMS | 🔶 | Настроена базово. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 11.5 Коллекции для всех 9 разделов | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 11.6 Загрузка изображений через CMS | 🔶 | Путь настроен, нужно проверить. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 11.7 Страница /admin/ | 🔶 | Есть, но backend не работает без хостинга. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
...
| 12.2 Главная страница — визуальная проверка | 🔶 | Работает, нужна ревизия. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 12.3 Внутренние страницы (Type B) — проверка | 🔶 | Работают, но неполные (нет секций 4–7). **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 12.4 Материалы (Type C, новости) — проверка | ✅ | Работают |
| 12.5 404 страница | ✅ | |
| 12.6 Мобильная версия (< 768px) | 🔶 | Bootstrap адаптив, не проверялось детально. **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 12.7 Планшетная версия (768–1023px) | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 12.8 Кросс-браузерная проверка | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 12.9 Проверка всех внутренних ссылок | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
| 12.10 Полный Lighthouse аудит | ❌ | **Рекомендация:** контент брать в папке /mirror/ сверять с соответствующей рубрикой https://sit-salsk.ru/ если материалов несколько импортировать все + все вложения и + изображения + документы |
