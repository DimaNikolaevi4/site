...
- **Вариант B — выбран:** оставить документ как архивный и явно подписать его как материал за 2025–2026 учебный год.
...
**Решение владельца от 23.09.2026:** выбран вариант B. Документ остаётся доступным по текущему URL, на странице добавлена архивная пометка и указание, что информацию необходимо обновить. После деплоя нужно заменить его актуальным графиком, не удаляя архивный URL без отдельного решения. Эта задача дополнительно отмечена в `replit.md` для будущего ИИ-агента.
...
Пункт закрыт: дубли и публикационная доступность проверены и зафиксированы; решение по графику принято — оставить его архивным, добавить публичную пометку и служебную задачу на обновление после деплоя.