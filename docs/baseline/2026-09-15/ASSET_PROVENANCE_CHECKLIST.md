...
- Для заменяемых изображений №34 и №38 сохранить размеры оригиналов; для №35 сделать новый вариант уже текущего и использовать цветовые акценты сайта https://сит-сальск.рф/
