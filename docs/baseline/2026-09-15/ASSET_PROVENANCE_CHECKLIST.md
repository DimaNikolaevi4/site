...
4. Для `assets/template/hero-bg.jpg` приоритетное решение — заменить, если источник не будет найден
...
|-----------|-------|-------------|-------------|--------------|
| **Всего изображений** | **133** | **~129** | **2** | **1** | **0** |
...
- Для заменяемого изображения №38 сохранить размеры оригинала; для №35 сделать новый вариант уже текущего и использовать цветовые акценты сайта https://сит-сальск.рф/
