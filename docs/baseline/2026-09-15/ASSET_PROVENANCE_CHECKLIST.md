...
| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 67-116 | [assets/uploads/virtualnaya-ekskursiya/](https://sit-salsk.ru) (46 файлов WhatsApp-Image-*.jpeg) | CLAIM_REQUIRES_EVIDENCE | Фото помещений техникума для виртуальной экскурсии. Отправлены через WhatsApp | ✅ **Оставить** (фото помещений СИТ) |
