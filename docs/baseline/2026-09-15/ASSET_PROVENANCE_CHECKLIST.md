...
1. Проверяются 133 оригинальных изображения; производные WebP отдельно не дублируются
...
4. Для `assets/template/hero-bg.jpg` источник и способ создания должны быть зафиксированы в provenance-чеклисте
...
| 35 | [assets/template/hero-bg.jpg](https://сит-сальск.рф/assets/template/hero-bg.jpg) | AI_GENERATED / DOCUMENTED | Фоновое изображение сгенерировано ИИ GigaChat для проекта; выполнено в цветовой палитре сайта https://сит-сальск.рф/ | ✅ **Оставить (документ)** |
...
**46 WebP-копий.** Их источник наследуется от соответствующего оригинала с тем же базовым именем; отдельный комментарий не нужен, если оригинал подтверждён.
...
|-----------|-------|-------------|-------------|--------------|
| **Всего изображений** | **133** | **~130** | **1** | **1** | **0** |

### Приоритетные действия

#### 🔴 Красный уровень (срочно):
1. **#35** `assets/template/hero-bg.jpg` — **ОСТАВИТЬ** (сгенерировано ИИ GigaChat, документировано в чек-листе)
...
- Для заменяемого изображения №38 сохранить размеры оригинала и для нового изображения №35 использовать цветовые акценты сайта https://сит-сальск.рф/
- Изображение №35 сгенерировано ИИ GigaChat и зафиксировано как документированный новый материал.
- Изображение №34 удалено из проекта, поскольку его источник и права использования не были подтверждены.
- Изображение №20 сгенерировано ИИ Qwen и зафиксировано как документированный новый материал; исходный скачанный файл заменён.
