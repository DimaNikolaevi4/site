...
Для каждого оригинального изображения укажите:
- Откуда оно взято
- Кто правообладатель или предоставил материал
- Есть ли разрешение / официальный источник
- Решение — оставить, заменить или удалить

**Важно:** Не используйте формулировку о письменном согласии детей и родителей, если таких документов нет.

### Правила заполнения

1. Проверяются 140 оригинальных изображений; производные WebP отдельно не дублируются
2. Для логотипов и государственных символов укажите ведомство и URL официального источника
3. Для фотографий с официального сайта техникума укажите URL страницы-источника и основание публикации
4. Для серии `assets/images/hero/` источник и способ создания должны быть зафиксированы в provenance-чек-листе
...
| 20 | [assets/images/vypusknikam/bud-vostrebovannym-1.jpg](https://сит-сальск.рф/assets/images/vypusknikam/bud-vostrebovannym-1.jpg) | AI_GENERATED / DOCUMENTED | Изображение сгенерировано ИИ Qwen3.7-Plus для проекта; создано заново вместо ранее скачанного материала | ✅ **Оставить (документ)** |
...
| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 34 | [assets/template/about.jpg](https://сит-сальск.рф/assets/template/about.jpg) | UNKNOWN / NO VERIFIED SOURCE | Источник и права на ранее использованный материал не подтверждены; файл удалён из проекта | 🗑️ **Удалить (документ)** |
...
| 38 | [assets/uploads/i.jpeg](https://сит-сальск.рф/assets/uploads/i.jpeg) | UNKNOWN / NO VERIFIED SOURCE | Источник и права на ранее использованный материал не подтверждены; файл удалён из проекта | 🗑️ **Удалить (документ)** |

#### 4.2. Международное сотрудничество

| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 39-47 | [assets/uploads/mezhdunarodnoe/](https://sit-salsk.ru/mezhdunarodnoe) (9 файлов) | CLAIM_REQUIRES_EVIDENCE | Фото с мероприятий международного сотрудничества. Источник: sit-salsk.ru/mezhdunarodnoe | ✅ **Оставить** (фото мероприятий СИТ) |

#### 4.3. МТО (кабинеты и лаборатории)

| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 48-57 | [assets/uploads/mto/main/](https://sit-salsk.ru) (10 файлов кабинетов) | CLAIM_REQUIRES_EVIDENCE | Фото кабинетов и лабораторий техникума. Источник: sit-salsk.ru (раздел МТО) | ✅ **Оставить** (фото помещений СИТ) |

#### 4.4. Руководство

| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 58 | [assets/uploads/rukovodstvo/barabash.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/barabash.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 59 | [assets/uploads/rukovodstvo/beznickaya.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/beznickaya.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 60 | [assets/uploads/rukovodstvo/korotya.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/korotya.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 61 | [assets/uploads/rukovodstvo/krasnokutskaya.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/krasnokutskaya.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 62 | [assets/uploads/rukovodstvo/lomaka.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/lomaka.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 63 | [assets/uploads/rukovodstvo/senchenko.jpeg](https://сит-сальск.рф/assets/uploads/rukovodstvo/senchenko.jpeg) | CLAIM_REQUIRES_EVIDENCE | Фото директора **Сенченко М.Е.** с официального сайта | ✅ **Оставить** |
| 64 | [assets/uploads/rukovodstvo/shelestyan.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/shelestyan.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 65 | [assets/uploads/rukovodstvo/yakimova.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/yakimova.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |
| 66 | [assets/uploads/rukovodstvo/yarovoy.jpg](https://сит-сальск.рф/assets/uploads/rukovodstvo/yarovoy.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото с официального сайта sit-salsk.ru/rukovodstvo | ✅ **Оставить** |

#### 4.5. Виртуальная экскурсия (WhatsApp Images)

| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 67-116 | [assets/uploads/virtualnaya-ekskursiya/](https://sit-salsk.ru) (46 файлов WhatsApp-Image-*.jpeg в текущем проекте; диапазон сохранён по исходному перечню) | CLAIM_REQUIRES_EVIDENCE | Фото помещений техникума для виртуальной экскурсии. Отправлены через WhatsApp | ✅ **Оставить** (фото помещений СИТ) |

#### 4.6. Другие загрузки

| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 117 | [assets/uploads/vsoko/vsoko.jpg](https://сит-сальск.рф/assets/uploads/vsoko/vsoko.jpg) | CLAIM_REQUIRES_EVIDENCE | ВСОКО | ✅ **Оставить** |
| 118 | [assets/uploads/Внимание-4.jpg](https://сит-сальск.рф/assets/uploads/Внимание-4.jpg) | CLAIM_REQUIRES_EVIDENCE | Объявление | ✅ **Оставить** |
| 119 | [assets/uploads/Слайд1.jpg](https://сит-сальск.рф/assets/uploads/Слайд1.jpg) | CLAIM_REQUIRES_EVIDENCE | Презентация | ✅ **Оставить** |
| 120 | [assets/uploads/молодежь2016.jpg](https://сит-сальск.рф/assets/uploads/молодежь2016.jpg) | CLAIM_REQUIRES_EVIDENCE | Фото 2016 года | ✅ **Оставить** (архивное фото) |
| 121 | [assets/uploads/объявление.png](https://сит-сальск.рф/assets/uploads/объявление.png) | CLAIM_REQUIRES_EVIDENCE | Объявление | ✅ **Оставить** |
| 122 | [assets/uploads/презентация-атп-2016-3.jpeg](https://сит-сальск.рф/assets/uploads/презентация-атп-2016-3.jpeg) | CLAIM_REQUIRES_EVIDENCE | Презентация АТП 2016 | ✅ **Оставить** |
| 123 | [assets/uploads/срро.jpg](https://сит-сальск.рф/assets/uploads/срро.jpg) | CLAIM_REQUIRES_EVIDENCE | СРРО | ✅ **Оставить** |
...
### 7. images/ikonccilki (логотипы ведомств)

| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 129 | [images/ikonccilki/cropped-logo_rosobrnadzor-2.png](https://сит-сальск.рф/images/ikonccilki/cropped-logo_rosobrnadzor-2.png) | CLAIM_REQUIRES_EVIDENCE | **Рособрнадзор**. Официальный логотип | ✅ **Оставить** (источник: https://obrnadzor.gov.ru/) |
| 130 | [images/ikonccilki/don-logo.svg](https://сит-сальск.рф/images/ikonccilki/don-logo.svg) | CLAIM_REQUIRES_EVIDENCE | **Ростовская область**. Логотип региона | ✅ **Оставить** |
| 131 | [images/ikonccilki/government.svg](https://сит-сальск.рф/images/ikonccilki/government.svg) | CLAIM_REQUIRES_EVIDENCE | **Правительство РФ**. Официальный логотип | ✅ **Оставить** (государственная символика) |
| 132 | [images/ikonccilki/rostrud.gov.svg](https://сит-сальск.рф/images/ikonccilki/rostrud.gov.svg) | CLAIM_REQUIRES_EVIDENCE | **Роструд**. Официальный логотип | ✅ **Оставить** (источник: https://www.rostrud.gov.ru/) |
| 133 | [images/ikonccilki/лого_мин_рост.png](https://сит-сальск.рф/images/ikonccilki/лого_мин_рост.png) | CLAIM_REQUIRES_EVIDENCE | **Минпросвещения России**. Официальный логотип | ✅ **Оставить** (источник: https://edu.gov.ru/) |
...
| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 134 | [images/logos/404.gif](https://сит-сальск.рф/images/logos/404.gif) | CLAIM_REQUIRES_EVIDENCE | Страница 404 | ✅ **Оставить** (технический) |
| 135 | [images/logos/narodnyj-front-2025.png](https://сит-сальск.рф/images/logos/narodnyj-front-2025.png) | CLAIM_REQUIRES_EVIDENCE | **Народный фронт**. Логотип организации | ✅ **Оставить** (логотип партнёра) |
| 136 | [images/logos/nf-2025.png](https://сит-сальск.рф/images/logos/nf-2025.png) | CLAIM_REQUIRES_EVIDENCE | **Народный фронт**. Логотип организации | ✅ **Оставить** (логотип партнёра) |
...
| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 137 | [images/sliders/slider1.jpg](https://сит-сальск.рф/images/sliders/slider1.jpg) | CLAIM_REQUIRES_EVIDENCE | Слайдер с официального сайта | ✅ **Оставить** (фото СИТ) |

---

## 10. Производные WebP

**44 WebP-копии.** Их источник наследуется от соответствующего оригинала с тем же базовым именем; отдельный комментарий не нужен, если оригинал подтверждён.

---

## Итоговая статистика

| Категория | Всего | ✅ Оставить | ⚠️ Заменить | 🗑️ Удалить | 🔍 Проверить |
|-----------|-------|-------------|-------------|--------------|
| **Всего изображений** | **140** | **138** | **0** | **2** | **0** |

### Приоритетные действия

#### 🔴 Красный уровень (срочно):
1. **#35.1–35.8** `assets/images/hero/hero-students-01.jpg` … `hero-students-08.jpg` — **ОСТАВИТЬ** (сгенерировано ИИ Qwen3.7-Plus, технически обработано в GIMP и документировано в чек-листе)
2. **#20** `assets/images/vypusknikam/bud-vostrebovannym-1.jpg` — **ОСТАВИТЬ** (сгенерировано ИИ Qwen3.7-Plus, документировано в чек-листе)
3. **#34** `assets/template/about.jpg` — **УДАЛИТЬ** (источник и права не подтверждены)
4. **#38** `assets/uploads/i.jpeg` — **УДАЛИТЬ** (источник и права не подтверждены)
...
- Все фото с официального сайта sit-salsk.ru — **ОСТАВИТЬ** (с пометкой "Источник: sit-salsk.ru; выполнено Медиагруппой СИТ")
...
- Фотографии с официального сайта техникума выполнены Медиагруппой СИТ
...
- Изображение №20 сгенерировано ИИ Qwen3.7-Plus и зафиксировано как документированный новый материал; исходный скачанный файл заменён.

**Дата заполнения:** 19 сентября 2026 
