...
|-----------|-------|-------------|-------------|--------------|
| **Всего изображений** | **140** | **~137** | **1** | **1** | **0** |
...
- Для заменяемого изображения №38 сохранить размеры оригинала; изображения №35.1–35.8 подготовлены в цветовых акцентах сайта https://сит-сальск.рф/
