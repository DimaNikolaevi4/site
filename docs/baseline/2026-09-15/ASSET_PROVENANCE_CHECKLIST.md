...
| № | Изображение | Предварительный статус | Комментарий владельца проекта | Решение |
|---|-------------|------------------------|-------------------------------|---------|
| 67-116 | [assets/uploads/virtualnaya-ekskursiya/](https://sit-salsk.ru) (~50 файлов WhatsApp-Image-*.jpeg) | CLAIM_REQUIRES_EVIDENCE | Фото помещений техникума для виртуальной экскурсии. Отправлены через WhatsApp | ✅ **Оставить** (фото помещений СИТ) |
...
**54 WebP-копии.** Их источник наследуется от соответствующего оригинала с тем же базовым именем; отдельный комментарий не нужен, если оригинал подтверждён.
...
|-----------|-------|-------------|-------------|--------------|
| **Всего изображений** | **140** | **~137** | **0** | **2** | **0** |
