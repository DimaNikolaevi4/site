...
1. Для 24 файлов выше указать официальный источник или разрешение отдельным полем/реестром.
2. Назначить правило для материалов, которые нельзя менять без согласования: роль согласующего, перечень разделов и способ фиксации решения.
3. Выполнить содержательную проверку актуальности реквизитов и внешних документов; автоматическая проверка дат этого не заменяет.
